...
<body class="h-100">
	<a href="restoindex.html" class="btn mt-4" role="button" aria-pressed="true">
	...
	<div class="container h-100">
		<div class="row h-100 justify-content-center align-items-center">
			<div class="col-md-6 col-lg-6">
                ...
                <h1>Edit Profile</h1>
                    <!-- Input fields -->
                    <form action="restoEditProfileServlet"method="post">
                    <div class="form-example card p-4 mt-4" style="background-color:#CED8D1;border: #000000 1px solid;">
                        ...
                        <div class="form-group">
                            <button class="btn px-4 shadow-none" onclick="window.location.href='restoindex.html'" aria-pressed="true" id="cancelBtn" style="background-color: #B6C8BC;"> Cancel</button>
